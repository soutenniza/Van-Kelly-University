...
--
-- Host: localhost
-- Generation Time: Apr 15, 2015 at 05:03 AM
...
CREATE TABLE IF NOT EXISTS `Grantt` (
  `No` int(11) NOT NULL,
...
--
-- Table structure for table `Primaryy`
--

CREATE TABLE IF NOT EXISTS `Primaryy` (
